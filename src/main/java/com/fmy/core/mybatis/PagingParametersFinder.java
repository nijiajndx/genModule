...
//import com.sf.edms.dto.base.PageDto;
...
public enum  PagingParametersFinder {
     ...
     */
    public PageDto findCriteria(Object object) {
        if (object == null) {
            return null;
        }
        try {
     ...
     */
    private PageDto findCriteriaFromObject(Object object) {
     ...
     * @return PageQuery
     */
    private PageDto findCriteriaFromArray(Object array) {
     ...
     * @return PageQuery
     */
    private PageDto findCriteriaFromCollection(Collection collection) {
     ...
     * @return PaginationCriteria
     */
    private PageDto findCriteriaFromMap(Map map) {
