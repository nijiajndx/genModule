package com.fmy.core.mybatis.dialect.db;

import com.fmy.core.mybatis.dialect.Dialect;

import static com.fmy.core.mybatis.helpers.SqlRemoveHelper.removeOrders;
    ...
    public String getLimitString(String sql, int offset, String offsetPlaceholder, String limitPlaceholder) {
        ...
        if (offset >= 0) {
            pagingSelect.append(" ) row_ ) where rownum_ <= ")
                    .append(limitPlaceholder).append(" and rownum_ > ").append(offsetPlaceholder);
        } else {
